...
<body>
<div style="background-color:#c4c5c7;">
    <!-- Header -->
    <div class="container">
        <br />
        <!-- Tabs -->
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <a href="photos/2014 - Resume.pdf" target="_blank" class="pull-right" style="margin-right:25px; font-size:22px; color:#FFF;">Resume</a>
        ...
        <div class="container" style="min-height:400px;">
            <center>
                <div class="row">
                    ...
                    <br />
                    <div class="col-lg-offset-1 col-md-offset-1 col-sm-offset1 col-lg-10 col-md-10 col-sm-10" style="font-size:18px;">
                        My name is Matt Ellis. I am currently a Senior Computer Science major at Clemson University.
                        Through my internship at the university, I have gained valuable knowledge of web
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-9 col-sm-9">
                ...
                <a href="caifcode.php" style="margin-right:50px;" class="pull-right" target="_blank"><h3>Sample Code &raquo;</h3></a>
            </div>
        </div><!-- End CAIF -->
        <!-- Rutland -->
        <div class="row">
            ...
            <div class="col-lg-9 col-md-9 col-sm-9">
                ...
                <a href="riecode.php" style="margin-right:50px;" class="pull-right" target="_blank"><h3>Sample Code &raquo;</h3></a>
            </div>
        </div><!-- End Rutland -->
        <br /><hr />
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-4">
                ...
                <br />
                <a href="photos/2014 - Resume.pdf" target="_blank" style="color:#FFF; font-size:18px;">My Resume</a>
            </div>
